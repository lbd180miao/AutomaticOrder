...
namespace RVC_CSharp
{
    class Program
    {
        ...
        {
            Console.WriteLine("usage: ./GetCaliBoardPoseX2 exposure_time_ms circle_center_distance_m circle_radius_m");
        ...
        static void Main(string[] args)
        {
            ...
            if (ret) { Console.WriteLine("LoadCaptureOptionParameters Succeed"); }
            ...
            ret = camera.GetIntrinsicParameters(cameraId, intrinsic_matrix, distortion);
            if (ret) { Console.WriteLine("GetIntrinsicParameters Succeed"); }

            ret = camera.GetExtrinsicMatrix(cameraId, extrinsic_matrix);
