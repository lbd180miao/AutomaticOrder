...
namespace RVC_CSharp
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            X2.CustomTransformOptions custom_trans_opt = X2.CustomTransformOptions.Default();
            custom_trans_opt.coordinate_select = X2.CustomTransformOptions.CoordinateSelect.CoordinateSelect_CameraLeft;
            if (info.support_extra)
            {
                custom_trans_opt.coordinate_select = X2.CustomTransformOptions.CoordinateSelect.CoordinateSelect_CameraExtra;
            }
