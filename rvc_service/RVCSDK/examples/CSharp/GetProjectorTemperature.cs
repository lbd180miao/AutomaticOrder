...
namespace RVC_CSharp
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            #region Step 1 ,Get Projector Temperature

            // Get Projector Temperature
            float temperature = 0.0f;
            camera.GetProjectorTemperature(ref temperature);
            Console.WriteLine($"投影仪温度--[projector temperature] = {temperature}");
            ...
            #region Step 3 , Data Process And Close
