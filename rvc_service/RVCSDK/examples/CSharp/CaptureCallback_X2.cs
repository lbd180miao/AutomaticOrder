...
namespace RVC_CSharp
{
    class Program
    {
        public static void X2CollectionCallBack(X2CollectionCallBackInfo info, X2.CaptureOptions options, IntPtr p)
        {
            // note: If camera support extra, info.left_image is extra image and info.right_image is empty image.
            info.left_image.SaveImage("D:/collection_left.png");
            info.right_image.SaveImage("D:/collection_right.png");
            return;
        }

        public static void X2CalculationCallBack(X2CalculationCallBackInfo info, X2.CaptureOptions options, IntPtr p)
        {
            info.depthmap.SaveDepthMap("D:/calculation.tiff");
            info.pointmap.SavePlyBinary("D:/calculation.ply");
            info.left_image.SaveImage("D:/calculation_left.png");
            info.right_image.SaveImage("D:/calculation_right.png");
            return;
        }
        ...
        static void Main()
        {
            ...
            bool success = X2_SetCollectionCallBack(camera.m_handle, X2CollectionCallBack, IntPtr.Zero);
            bool success2 = X2_SetCalculationCallBack(camera.m_handle, X2CalculationCallBack, IntPtr.Zero);
