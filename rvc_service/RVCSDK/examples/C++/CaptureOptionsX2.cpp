...
int main(int argc, char *argv[]) {
    ...
    std::cout << "Print capture options---" << std::endl;
    {
        ...
        std::cout << "[line_scanner_brightness_threshold] = {" << options.line_scanner_brightness_threshold << "}"
                  << std::endl;
        std::cout << "[correspond2d] = {" << options.correspond2d << "}" << std::endl;
        std::cout << "[trigger_mode] = {" << options.trigger_mode << "}" << std::endl;
        std::cout << "[encoder_trigger_interval] = {" << options.encoder_trigger_interval << "}" << std::endl;
        ...
        std::cout << "[line_scanner_confidence] = {" << options.line_scanner_confidence << "}" << std::endl;
