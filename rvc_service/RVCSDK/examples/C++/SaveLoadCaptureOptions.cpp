...
static void PrintCaptureOptions(RVC::X2::CaptureOptions &cap_opt) {
    ...
    std::cout << "x2.trigger_mode:" << cap_opt.trigger_mode << std::endl;
    std::cout << "x2.encoder_trigger_interval:" << cap_opt.encoder_trigger_interval << std::endl;
    ...
    std::cout << "x2.line_scanner_confidence" << cap_opt.line_scanner_confidence << std::endl;
    std::cout << "x2.truncate_z_min" << cap_opt.truncate_z_min << std::endl;
    std::cout << "x2.truncate_z_max" << cap_opt.truncate_z_max << std::endl;
}
